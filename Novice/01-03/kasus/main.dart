...
void main(){
  ...
  atm.add(akunatm1);atm[0].setPinAkun(123);atm[0].setNamaAkun("Nurul");atm[0].setSaldo(1000000);
  atm.add(akunatm2);atm[1].setPinAkun(456);atm[1].setNamaAkun("Yuda");atm[1].setSaldo(2000000);
  masukAkun(atm);
